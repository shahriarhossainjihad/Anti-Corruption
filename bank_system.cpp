...
public:
    void displayMenu() {
        ...
        std::cout << "\t\t\t Welcome to Anti- corrouption  \n\n\n";
        std::cout << "\t\t\t____________ Select bank ___________\n\n\n";
        std::cout << "                             \n\n";
        std::cout << "\t\t\t\|\t\ Press 1 for city bank \t\t|\n";
        std::cout << "\t\t\t\|\t\ Press 2 for brac bank \t\t|\n";
        std::cout << "\t\t\t\|\t\ Press 3 for Islami bank \t\t|\n";
        std::cout << "\t\t\t\|\t\ Press 4 for Jamuna bank\t\t|\n";
